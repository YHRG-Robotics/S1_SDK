...
def main():
    ...
    parser.add_argument("--master_dev", type=str, default="COM23", help="主臂串口设备，例如 COM23 或 /dev/ttyUSB0")
    parser.add_argument("--slaver_dev", type=str, default="COM24", help="从臂串口设备，例如 COM23 或 /dev/ttyUSB0")
